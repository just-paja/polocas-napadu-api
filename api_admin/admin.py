...
from accounting.admin import (
    ...
    KnownAccountAdmin,
    MembershipAdmin,
    MembershipLevelAdmin,
    PromiseAdmin,
    PurposeAdmin,
    PurposeCategoryAdmin,
    StatementAdmin,
)
...
ADMIN_SITE.register(AccountAdmin.model, AccountAdmin)
...
ADMIN_SITE.register(CounterPartyAdmin.model, CounterPartyAdmin)
...
ADMIN_SITE.register(KnownAccountAdmin.model, KnownAccountAdmin)
...
ADMIN_SITE.register(MembershipAdmin.model, MembershipAdmin)
ADMIN_SITE.register(MembershipLevelAdmin.model, MembershipLevelAdmin)
...
ADMIN_SITE.register(PromiseAdmin.model, PromiseAdmin)
ADMIN_SITE.register(PurposeAdmin.model, PurposeAdmin)
ADMIN_SITE.register(PurposeCategoryAdmin.model, PurposeCategoryAdmin)
...
ADMIN_SITE.register(
    ShowVolumeCalibrationVotingAdmin.model, ShowVolumeCalibrationVotingAdmin
)
ADMIN_SITE.register(StatementAdmin.model, StatementAdmin)
